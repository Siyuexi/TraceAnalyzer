...
P2A_THIRD_PARTY_ROLLOUTS_PER_INSTANCE="${P2A_THIRD_PARTY_ROLLOUTS_PER_INSTANCE:-}"
P2A_THIRD_PARTY_PER_INSTANCE_PARALLELISM="${P2A_THIRD_PARTY_PER_INSTANCE_PARALLELISM:-}"
...
if [[ -n "${P2A_THIRD_PARTY_ROLLOUTS_PER_INSTANCE}" ]]; then
  run_cmd+=(--rollouts-per-instance "${P2A_THIRD_PARTY_ROLLOUTS_PER_INSTANCE}")
fi
if [[ -n "${P2A_THIRD_PARTY_PER_INSTANCE_PARALLELISM}" ]]; then
  run_cmd+=(--per-instance-parallelism "${P2A_THIRD_PARTY_PER_INSTANCE_PARALLELISM}")
fi
